...
namespace Carnac.Logic.KeyMonitor
{
    ...
    public class InterceptKeys : IInterceptKeys
    {
        ...
        readonly IObservable<InterceptKeyArgs> keyStream;
        // ReSharper disable once PrivateFieldCanBeConvertedToLocalVariable
        Win32Methods.LowLevelKeyboardProc callback;

        public InterceptKeys()
        {
            keyStream = Observable.Create<InterceptKeyArgs>(observer =>
            {
        ...
        public IObservable<InterceptKeyArgs> GetKeyStream()
        {
            return keyStream;
        }

        static InterceptKeyArgs CreateEventArgs(IntPtr wParam, IntPtr lParam)
        {
